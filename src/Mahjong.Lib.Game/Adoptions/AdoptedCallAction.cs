...
public record AdoptedCallAction : AdoptedRoundAction
{
    public PlayerIndex CallerIndex { get; init; }
    public CallType CallType { get; init; }
    public ImmutableList<Tile> HandTiles { get; init; }

    public AdoptedCallAction(PlayerIndex callerIndex, CallType callType, ImmutableList<Tile> handTiles)
    {
    ...
    public virtual bool Equals(AdoptedCallAction? other)
    {
