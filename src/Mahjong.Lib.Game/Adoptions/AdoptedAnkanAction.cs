...
/// 暗槓採用結果
/// </summary>
public record AdoptedAnkanAction : AdoptedKanAction
{
    /// <summary>暗槓対象の4枚</summary>
    public ImmutableArray<Tile> Tiles { get; init; }

    public AdoptedAnkanAction(ImmutableArray<Tile> tiles)
    {
        if (tiles.Length != 4)
        {
    ...
    public virtual bool Equals(AdoptedAnkanAction? other)
    {
