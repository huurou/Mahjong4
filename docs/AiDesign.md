...
- 対局数: 50 局 × 2 シード (`--seed 1` / `--seed 2`)

| シード | AI | 平均順位 | 和了率 | 放銃率 | 立直率 | 副露率 | 平均打点 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | v0.2.0 有効牌 | 2.500 | 22.3% | 16.0% | 44.1% | 0.0% | 6646 |
| 1 | v0.3.0 評価値 | 2.500 | 22.5% | 17.7% | 45.5% | 0.0% | 6562 |
| 2 | v0.2.0 有効牌 | 2.612 | 20.6% | 16.6% | 39.4% | 0.0% | 6686 |
| 2 | v0.3.0 評価値 | **2.388** | **23.6%** | 16.2% | **45.9%** | 0.0% | 6707 |

シード 2 では v0.3.0 が平均順位 0.22 改善 / 和了率 +3.0pt / 立直率 +6.5pt で明確に優位。シード 1 は平均順位タイで差が小さく、サンプル数 50 局では揺らぎが大きい。役分布は双方とも立直 / 赤ドラ / 裏ドラ / ドラ / 一発 / 門前清自摸和 / 平和が上位を占める構成で大きな差はなかった。
