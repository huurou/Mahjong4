...
- テストはfeatureドメインごとのディレクトリに整理する（Lib.Scoring.Tests: Tiles/, Calls/, Fus/, Games/, Yakus/, Shantens/, HandCalculating/　Lib.Game.Tests: Tiles/, Calls/, Candidates/, Inquiries/, Adoptions/, Games/, Hands/, Notifications/, Players/, Responses/, Rivers/, Rounds/, States/, Views/, Walls/）
