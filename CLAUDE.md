...
- **採用結果** ([Mahjong.Lib.Game/Resolutions/](src/Mahjong.Lib.Game/Resolutions/)) — `ResolvedRoundAction` は応答集約・優先順位適用後の採用結果 (和了/流局/打牌/副露/槓 等)
...
- テストはfeatureドメインごとのディレクトリに整理する（Lib.Scoring.Tests: Tiles/, Calls/, Fus/, Games/, Yakus/, Shantens/, HandCalculating/　Lib.Game.Tests: Tiles/, Calls/, Candidates/, Inquiries/, Resolutions/, Games/, Hands/, Notifications/, Players/, Responses/, Rivers/, Rounds/, States/, Views/, Walls/）
