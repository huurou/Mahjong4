...
public class Round_SettleWinPaoTests
{
    ...
    public void ツモ和了で包適用_責任者1人が全額負担()
    {
        ...
        // Act
        var result = round.SettleWin([winner], winner, WinType.Tsumo, mock.Object);
    ...
    public void ロン和了で放銃者と責任者が同一_全額を同一プレイヤーが負担()
    {
        ...
        // Act
        var result = round.SettleWin([winner], loserAndResponsible, WinType.Ron, mock.Object);
    ...
    public void 大三元ツモで包適用_通知明細のScoreResultも責任者1人負担のdelta()
    {
        ...
        // Act
        round.SettleWin([winner], winner, WinType.Tsumo, mock.Object, out var details);
    ...
    public void 大三元ロンで包適用_通知明細のScoreResultも放銃者と責任者折半()
    {
        ...
        // Act
        round.SettleWin([winner], loser, WinType.Ron, mock.Object, out var details);
