...
public class PlayerWindSouth_ValidTests
{
    ...
    public void Valid_東家で東の刻子あり_成立しない()
    {
        ...
        // Act
        var actual = PlayerWindSouth.Valid(hand, callList, winSituation);
    ...
    [Fact]
    public void Valid_東家で南の刻子あり_成立しない()
    {
        // Arrange
    ...
    [Fact]
    public void Valid_南家で東の刻子あり_成立しない()
    {
        // Arrange
        var hand = new Hand([new(pin: "11"), new(man: "234"), new(sou: "234"), new(honor: "ttt")]);
        var callList = new CallList();
    ...
    [Fact]
    public void Valid_南家で南の明槓あり_成立する()
    {
        // Arrange
    ...
    [Fact]
    public void Valid_南家で南の暗槓あり_成立する()
    {
        // Arrange
        var hand = new Hand([new(pin: "11"), new(man: "234"), new(sou: "234")]);
    ...
    [Fact]
    public void Valid_西家で南の刻子あり_成立しない()
    {
        // Arrange
        var hand = new Hand([new(pin: "11"), new(man: "234"), new(sou: "234"), new(honor: "nnn")]);
        var callList = new CallList();
    ...
    [Fact]
    public void Valid_西家で西の刻子あり_成立しない()
    {
        // Arrange
    ...
    [Fact]
    public void Valid_北家で南の刻子あり_成立しない()
    {
        // Arrange
        var hand = new Hand([new(pin: "11"), new(man: "234"), new(sou: "234"), new(honor: "nnn")]);
        var callList = new CallList();
