...
public class PlayerWindNorth_ValidTests
{
    [Fact]
    public void Valid_東家で東の刻子あり_成立しない()
    {
        ...
        // Act
        var actual = PlayerWindNorth.Valid(hand, callList, winSituation);
    ...
    [Fact]
    public void Valid_東家で北の刻子あり_成立しない()
    {
        // Arrange
    ...
    [Fact]
    public void Valid_南家で北の刻子あり_成立しない()
    {
        // Arrange
        var hand = new Hand([new(pin: "11"), new(man: "234"), new(sou: "234"), new(honor: "ppp")]);
        var callList = new CallList();
    ...
    [Fact]
    public void Valid_西家で北の刻子あり_成立しない()
    {
        // Arrange
        var hand = new Hand([new(pin: "11"), new(man: "234"), new(sou: "234"), new(honor: "ppp")]);
        var callList = new CallList();
    ...
    [Fact]
    public void Valid_北家で東の刻子あり_成立しない()
    {
        // Arrange
        var hand = new Hand([new(pin: "11"), new(man: "234"), new(sou: "234"), new(honor: "ttt")]);
        var callList = new CallList();
    ...
    [Fact]
    public void Valid_北家で北の明槓あり_成立する()
    {
        // Arrange
    ...
    [Fact]
    public void Valid_北家で北の暗槓あり_成立する()
    {
        // Arrange
        var hand = new Hand([new(pin: "11"), new(man: "234"), new(sou: "234")]);
