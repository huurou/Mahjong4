...
public class PlayerWindEast_ValidTests
{
    [Fact]
    public void Valid_東家で東の刻子あり_成立する()
    {
        ...
        // Act
        var actual = PlayerWindEast.Valid(hand, callList, winSituation);
    ...
    [Fact]
    public void Valid_東家で東の明槓あり_成立する()
    {
        // Arrange
    ...
    [Fact]
    public void Valid_東家で東の暗槓あり_成立する()
    {
        // Arrange
        var hand = new Hand([new(pin: "11"), new(man: "234"), new(sou: "234")]);
